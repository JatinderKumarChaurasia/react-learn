...
export const UserSearchRef: React.FunctionComponent = () => {
    ...
    return <div>
        <input ref={inputRef} className='rounded p-1 m-2 border-2 ring-2 border-amber-300' type={name} inputMode='text' onChange={(e) => setName(e.target.value)} placeholder='Enter the username to search'/>
